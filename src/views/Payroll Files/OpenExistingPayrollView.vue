    ...
    <table id="'only-css'">
      <tbody>
        ...
        <tr>
          ...
          <td style="text-align:right;">{{ parseFloat(data['housingAllowance' as keyof typeof data]).toFixed(2) }}</td>
          <td style="color:red">AIDS Levy USD:</td>
          <td style="color: red; text-align: right;">{{ parseFloat(data['aidsLevyUSD' as keyof typeof data]).toFixed(2)
            }}</td>
        </tr>
        <tr>
